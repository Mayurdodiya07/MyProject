  	...
  	{  
		...
		{  
			...
			{  
				...
				document.getElementById('MD').innerHTML=val;
          ...
          <form class="form-contact contact_form" action="UserController" method="post" name="signup" >
            <div class="row">
             ...
             <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="address" id="address" cols="30" rows="9" placeholder="Enter your  Address">
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="cpassword" id="password" type="password" placeholder="Enter your confirm password">
                </div>
              </div>
